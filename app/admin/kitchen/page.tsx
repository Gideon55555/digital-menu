...
const KITCHEN_TITLE = 'Kitchen'
const KITCHEN_DESCRIPTION = 'Prepare food orders'
      ...
      <div className="space-y-6">
        ...
        {activeView === 'waiting' ? (
          <KitchenSection
            ...
            emptyTitle={`No waiting ${KITCHEN_TYPE === 'drinks' ? 'drink' : 'food'} orders`}
          ...
          <KitchenSection
            title="Preparing"
            description={`${KITCHEN_TYPE === 'drinks' ? 'Drinks' : 'Food'} currently being prepared`}
            count={preparingOrders.length}
            orders={preparingOrders}
            emptyTitle={`Nothing is being prepared`}
            emptyDescription={`Orders will appear here when the ${KITCHEN_TYPE === 'drinks' ? 'drinks' : 'food'} chef starts preparing them.`}
            tableName={getTableName}
            getItemName={getItemName}
            getOrderAge={getOrderAge}
            updatingOrder={updatingOrder}
